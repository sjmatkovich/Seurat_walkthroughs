...
scVIIntegration <- function(
  ...
  # import python methods from specified virtual env
  reticulate::use_virtualenv(virtual_env, required = TRUE)
  ...
  # so there's no guarantee that the usual naming conventions will be followed
